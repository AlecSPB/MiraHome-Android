 ...
 */
public class WheelWeightUnitPicker extends WheelCurvedPicker {
    ...
    public WheelWeightUnitPicker(Context context) {
        super(context);
        init();
    }

    public WheelWeightUnitPicker(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
