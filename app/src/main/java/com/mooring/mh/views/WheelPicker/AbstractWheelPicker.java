...
public abstract class AbstractWheelPicker extends View implements IWheelPicker {
    ...
    public interface OnWheelChangeListener {
        ...
        void onWheelSelected(View view, int index, String data);
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        onWheelSelected(this, itemIndex, data.get(itemIndex));
    ...
    protected void onWheelSelected(View view, int index, String data) {
        if (null != mListener) {
            mListener.onWheelSelected(view, index, data);
        }
    }
